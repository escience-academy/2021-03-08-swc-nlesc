...
venue: "Software Carpentry with Python"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "March 8-11, 2021"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Pablo Rodriguez-Sanchez", "Jens Wehner"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Hanno Spreeuw", "Francesco Nattino"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: "141258972389"     # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
